...
local lang = redis:get(hash) 
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = 'ℹ About Us ', callback_data = '/venus:'..GP_id}
		},
		{
  ...
  elseif lang then
	 text = '_به تنظیمات کلی خوش آمدید_'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
		...
		{
			{text = 'ℹ درباره ما', callback_data = '/venus:'..GP_id}
		},
		{
...
local settings = data[tostring(GP_id)]["settings"]
 ...
 text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = '⚠ Flood Sensitivity ', callback_data = 'VenuaOfficial'}
		},
		{
		...
		{
			{text = '↔ Character Sensitivity ', callback_data = 'VenuaOfficial'}
		},
		{
		...
		{
			{text = '⏰  Flood Check Time ', callback_data = 'VenuaOfficial'}
		},
		{
 ...
 text = '_به تنظیمات بیشتر خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = '⚠ حداکثر پیام های مکرر ', callback_data = 'VenuaOfficial'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="VenuaOfficial"},
		...
		{
			{text = '↔ حداکثر حروف مجاز ', callback_data = 'VenuaOfficial'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="VenuaOfficial"},
		...
		{
			{text = '⏰ زمان بررسی پیام های مکرر ', callback_data = 'VenuaOfficial'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="VenuaOfficial"},
...
local lang = redis:get(hash) 
 ...
 text = '_Welcome To_ *Group Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = "• Lock Edit", callback_data='VenuaOfficial'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "• Lock Link", callback_data='VenuaOfficial'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "• Lock Tags", callback_data='VenuaOfficial'}, 
			{text = lock_tag, callback_data="/locktags:"..GP_id}
		},
		{
			{text = "• Lock Join", callback_data='VenuaOfficial'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "• Lock Flood", callback_data='VenuaOfficial'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "• Lock Spam", callback_data='VenuaOfficial'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "• Lock Mention", callback_data='VenuaOfficial'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "• Lock Arabic", callback_data='VenuaOfficial'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "• Lock Webpage", callback_data='VenuaOfficial'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "• Lock Markdown", callback_data='VenuaOfficial'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "• Lock Pin", callback_data='VenuaOfficial'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "• Lock Bots", callback_data='VenuaOfficial'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "• Group Welcome", callback_data='VenuaOfficial'}, 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = "• قفل ویرایش", callback_data='VenuaOfficial'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "•  قفل لینک", callback_data='VenuaOfficial'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "• قفل تگ", callback_data='VenuaOfficial'}, 
			{text = lock_tag, callback_data="/locktags:"..GP_id}
		},
		{
			{text = "• قفل ورود", callback_data='VenuaOfficial'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "• قفل پیام های مکرر", callback_data='VenuaOfficial'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "• قفل هرزنامه", callback_data='VenuaOfficial'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "• قفل فراخوانی", callback_data='VenuaOfficial'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "• قفل عربی", callback_data='VenuaOfficial'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "• قفل صفحات وب", callback_data='VenuaOfficial'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "• قفل فونت", callback_data='VenuaOfficial'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "• قفل سنجاق کردن", callback_data='VenuaOfficial'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "•  قفل ربات ها", callback_data='VenuaOfficial'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "• خوشآمد گویی", callback_data='VenuaOfficial'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   if not lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "• Mute All", callback_data='VenuaOfficial'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "• Mute Gifs", callback_data='VenuaOfficial'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "• Mute Text", callback_data='VenuaOfficial'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "• Mute Inline", callback_data='VenuaOfficial'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "• Mute Game", callback_data='VenuaOfficial'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "• Mute Photo", callback_data='VenuaOfficial'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "• Mute Video", callback_data='VenuaOfficial'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "• Mute Audio", callback_data='VenuaOfficial'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "• Mute Voice", callback_data='VenuaOfficial'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "• Mute Sticker", callback_data='VenuaOfficial'}, 
			{text = mute_sticker, callback_data="/mutesticker:"..GP_id}
		},
		{
			{text = "• Mute Contact", callback_data='VenuaOfficial'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "• Mute Forward", callback_data='VenuaOfficial'}, 
			{text = mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "• Mute Location", callback_data='VenuaOfficial'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "• Mute Document", callback_data='VenuaOfficial'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "• Mute TgService", callback_data='VenuaOfficial'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "• Mute Keyboard", callback_data='VenuaOfficial'}, 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "• بیصدا همه", callback_data='VenuaOfficial'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "• بیصدا تصاویر متحرک", callback_data='VenuaOfficial'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "• بیصدا متن", callback_data='VenuaOfficial'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "• بیصدا اینلاین", callback_data='VenuaOfficial'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "• بیصدا بازی", callback_data='VenuaOfficial'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "• بیصدا عکس", callback_data='VenuaOfficial'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "• بیصدا فیلم", callback_data='VenuaOfficial'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "• بیصدا آهنگ", callback_data='VenuaOfficial'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "•  بیصدا صدا", callback_data='VenuaOfficial'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "• بیصدا استیکر", callback_data='VenuaOfficial'}, 
			{text = mute_sticker, callback_data="/mutesticker:"..GP_id}
		},
		{
			{text = "• بیصدا مخاطب", callback_data='VenuaOfficial'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "• بیصدا نقل و قول", callback_data='VenuaOfficial'}, 
			{text = mutes.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "• بیصدا موقعیت", callback_data='VenuaOfficial'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "• بیصدا فایل", callback_data='VenuaOfficial'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "• بیصدا خدمات تلگرام", callback_data='VenuaOfficial'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "• بیصدا کیبورد", callback_data='VenuaOfficial'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = '🔙 بازگشت ', callback_data = '/option:'..GP_id}
...
if matches[1] == '/filterlist' then
   ...
   if not lang then
    ...
    if not lang then
		...
		keyboard.inline_keyboard = {
			{
				{text = "• Clean Filter List", callback_data="/cleanfilterlist:"..matches[2]}
			},
			{ 
				{text = "🔙 Back", callback_data="/more:"..matches[2]}
			}
   ...
   elseif lang then
		...
		keyboard.inline_keyboard = {
			{
				{text = "• پاک کردن کلمات فیلتر شده", callback_data="/cleanfilterlist:"..matches[2]}
			},
			{ 
				{text = "🔙 بازگشت", callback_data="/more:"..matches[2]}
			}
...
if matches[1] == '/link' then
   ...
   if not lang then
			text = "[🔰 Group Link]("..linkgp..")"
    elseif lang then
			text = "[🔰 لینک گروه]("..linkgp..")"
        end
		end
  if not lang then
		keyboard = {} 
...
if matches[1] == '/venus' then
	...
	keyboard.inline_keyboard = {
		{
			{text = "• Zakaria", callback_data="/zakaria:"..matches[2]}
		},
		{
			{text = '• Our GitHub ', url = 'https://www.github.com/ZakariaRasoli'}
		},
		{
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text =  "• زکریا", callback_data="/zakaria:"..matches[2]}
		},
		{
			{text = '• گیت هاب', url = 'https://www.github.com/ZakariaRasoli'}
		},
		{
...
local text = [[*• Zakaria Information*
*• Age :* `17`
*• Name :* `Zakaria Rasoli`
*• City :* `Bokan - KURDESTAN`
*• Language :* `KURDISH`
_-------------------------_
*• GitHub :*
...
_-------------------------_
*• Bridges :*
*• Pv : * [@ZakariaR](Telegram.Me/ZakariaR)
*• PvResan : * [@ZakariaR Pv](Telegram.Me/ZakariaPVBOT)
_-------------------------_]]
  if not lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "🔙 Back", callback_data="/venus:"..matches[2]}
			}
		}
  elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "🔙 بازگشت", callback_data="/venus:"..matches[2]}
			}
		}
  end
    edit_inline(msg.message_id, text, keyboard)
