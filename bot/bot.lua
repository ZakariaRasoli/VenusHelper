...
function create_config( )
	...
	if server_user:match("^root$") then
		VenusOfficial = '/root/Venus'
	elseif not server_user:match("^root$") then
		VenusOfficial = '/home/'..server_user..'/Venus'
	end
  ...
  config = {
    ...
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..VenusOfficial..'/data/moderation.json'},
    info_text = [[ ‌    ‍ ‌‌‌‌     *• Venus | Helper BOT v1.2*
`• An helper bot of` *VenusBOT* `based on` *VenusMassenger*

*• GitHub :* [Venus Helper](https://github.com/zakariarasoli/venushelper)

*• Founder & Developer :* [Zakaria](Telegram.Me/ZakariaR)

*• Special Thanks to :* [Beyond Team](Telegram.Me/BeyondTeam)

*• Our Channel :* [Venus](Telegram.Me/VenusOfficial)
]],
  }
